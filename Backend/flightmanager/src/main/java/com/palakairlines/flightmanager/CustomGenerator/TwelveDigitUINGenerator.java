...
public class TwelveDigitUINGenerator implements IdentifierGenerator {
    private static final int Desired_Length=12;
    ...
    private boolean isUniqueId(BigInteger id, SharedSessionContractImplementor session) {
        String queryString = "select count(entity) from Passenger entity where entity.passengerUIN = :idValue";
